...
import './MovieRead.css'; // Importa los estilos CSS
...
function ReadMovies() {
  ...
  return (
    <div className="readMovie-container">
      <h2 className="readMovie-title">Películas</h2>
      <div className="readMovie-search">
        <label>
      ...
      <div className="readMovie-back-button">
        <Link to="/movies">
      ...
      <table className="readMovie-table">
        <thead>
          <tr>
            <th>ID</th>
            <th>Nombre</th>
